            ...
            delegate: SliverChildListDelegate([
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                     Text('${'repairing_status'.tr} :', style: const TextStyle(fontSize: 16),),
                    Container(
                        ...
                        child: Row(
                          ...
                          children:  [
                            Text(repairingStatus.tr,style: const TextStyle(color: Colors.white,fontSize: 12),),
              ...
              SizedBox(
                  height: 100,
                  child:box.read('username') == widget.device.uploadedBy? DeleteButton(
